...
def default_config() -> VibeConfig:
    ...
    agents: Dict[str, AgentConfig] = {
        ...
        "web_info": agent(
            ...
            model="qwen-plus",
            web_search="on",
            purpose="Verify external facts via web search (fact-check only)",
            capabilities=["web", "fact_check", "verification"],
            io_schema="vibe.schemas.packs.WebInfoPack",
            ledger_write_types=["WEB_INFO_FETCHED"],
            tools_allowed=[],
        ),
